...
- **[[번역] 향상된 탄력성을 위한 최신 Microsoft 사고 대응 사전 서비스를 살펴보세요.](https://www.microsoft.com/en-us/security/blog/2026/01/07/explore-the-latest-microsoft-incident-response-proactive-services-for-enhanced-resilience/)**
  - Microsoft Incident Response의 새로운 사전 대응 서비스는 전문가 주도의 준비 및 고급 인텔리전스를 통해 보안 불확실성을 준비 상태로 전환합니다....
...
- **[[번역] 피싱 행위자는 도메인을 스푸핑하기 위해 복잡한 라우팅과 잘못된 구성을 악용합니다.](https://www.microsoft.com/en-us/security/blog/2026/01/06/phishing-actors-exploit-complex-routing-and-misconfigurations-to-spoof-domains/)**
  - `🔥익스플로잇`
  - 위협 행위자는 복잡한 라우팅 시나리오와 잘못 구성된 스푸핑 방지 기능을 악용하여 인터체인처럼 보이도록 제작된 스푸핑 피싱 이메일을 보내고 있습니다....
...
- **[[번역] Microsoft Defender Experts Suite 소개: 전문가 주도 서비스로 보안 강화](https://www.microsoft.com/en-us/security/blog/2026/01/06/introducing-the-microsoft-defender-experts-suite-elevate-your-security-with-expert-led-services/)**
  - 보안 팀이 최신 사이버 공격에 보조를 맞추는 데 도움이 되는 전문가 주도 서비스의 통합 세트인 Microsoft Defender Experts Suite를 발표합니다.
그만큼...
...
- **[[번역] 새로운 Microsoft 전자책: 포인트 솔루션이 방해가 되는 3가지 이유](https://www.microsoft.com/en-us/security/blog/2025/12/18/new-microsoft-e-book-3-reasons-point-solutions-are-holding-you-back/)**
  - 통합된 AI 지원 플랫폼이 어떻게 속도, 탄력성 및 측정 가능한 보안 이점을 제공하는지에 대한 새로운 Microsoft 전자책을 살펴보세요.
포스트 뉴 마이크로소프트...
...
- **[[번역] Access Fabric: ID 및 네트워크 액세스에 대한 현대적인 접근 방식](https://www.microsoft.com/en-us/security/blog/2025/12/17/access-fabric-a-modern-approach-to-identity-and-network-access/)**
  - Access Fabric은 누가 무엇에, 어디서, 어떤 조건에서 액세스할 수 있는지를 실시간으로 지속적으로 결정하는 통합 액세스 보안 솔루션입니다....
...
- **[[번역] 인스타그램, 1,700만 건의 계정 데이터 유출 주장 중 위반 사실 부인](https://www.bleepingcomputer.com/news/security/instagram-denies-breach-amid-claims-of-17-million-account-data-leak/)**
  - 인스타그램은 1,700만 개 이상의 인스타그램 데이터가 유출됐다고 주장하는 가운데 위협 행위자가 비밀번호 재설정 이메일을 대량으로 요청할 수 있는 버그를 수정했다고 밝혔습니다....
...
- **[[번역] 캘리포니아주, 수백만 건의 건강 데이터를 재판매하는 데이터 브로커 금지](https://www.bleepingcomputer.com/news/legal/california-bans-data-broker-reselling-health-data-of-millions/)**
  - 캘리포니아 개인정보 보호국(CalPrivacy)은 건강 및 개인 데이터를 판매한 Datamasters 마케팅 회사에 대해 조치를 취했습니다....
...
- **[[번역] Microsoft는 Word에서 'Kindle로 보내기' 기능을 중단합니다.](https://www.bleepingcomputer.com/news/microsoft/microsoft-is-retiring-send-to-kindle-in-word/)**
  - Microsoft는 Microsoft Word에서 직접 Kindle로 문서를 보낼 수 있는 기능을 중단합니다. [...]...
...
- **[[번역] BreachForums 해킹 포럼 데이터베이스가 유출되어 324,000개의 계정이 노출되었습니다.](https://www.bleepingcomputer.com/news/security/breachforums-hacking-forum-database-leaked-exposing-324-000-accounts/)**
  - 악명 높은 BreachForums 해킹 포럼의 최신 버전이 사용자 데이터베이스 테이블이 온라인으로 유출되면서 데이터 유출 사고를 겪었습니다. [...]...

#### SecurityWeek
- **[[번역] 공격자 십자선의 LLM, 위협 경고 인텔 회사](https://www.securityweek.com/llms-in-attacker-crosshairs-warns-threat-intel-firm/)**
  - 위협 행위자들은 다양한 LLM용 API에 액세스하기 위해 잘못 구성된 프록시 서버를 찾고 있습니다.
Attacker Crosshairs의 LLM 포스트는 위협을 경고합니다....

- **[[번역] EU, Google의 320억 달러 규모 Wiz 인수에 대한 판결 마감일을 2월로 설정](https://www.securityweek.com/eu-sets-february-deadline-for-verdict-on-googles-32b-wiz-acquisition/)**
  - 기록적인 거래는 이미 미국 정부로부터 승인을 받았습니다.
EU가 Google의 $에 대한 판결 마감일을 2월로 설정한 게시물...

- **[[번역] Torq, 12억 달러 가치 평가로 1억 4천만 달러 조달](https://www.securityweek.com/torq-raises-140-million-at-1-2-billion-valuation/)**
  - 회사는 투자금을 사용하여 플랫폼 채택을 가속화하고 연방 시장으로 확장할 것입니다.
포스트 Torq는 12억 달러로 1억 4천만 달러를 조달했습니다....

- **[[번역] 해커들이 하와이대학교 암센터 환자 데이터에 접근했습니다. 그들은 즉시 통보받지 못했습니다](https://www.securityweek.com/hackers-accessed-university-of-hawaii-cancer-center-patient-data-they-werent-immediately-notified/)**
  - UH 관계자는 어떤 암 연구 프로젝트가 영향을 받았는지, UH가 해커에게 돈을 되찾기 위해 지불한 금액 등 주요 정보 제공을 거부했습니다....

- **[[번역] 다른 소식: 8,000건의 랜섬웨어 공격, 중국이 미국 정부 이메일을 해킹, IDHS 위반이 70만 건에 영향을 미침](https://www.securityweek.com/in-other-news-8000-ransomware-attacks-china-hacked-us-gov-emails-idhs-breach-impacts-700k/)**
  - `💰랜섬웨어`
  - 레이더에 포착되지 않았을 수도 있는 다른 주목할만한 이야기: Jaguar Land Rover 판매 충돌, 수백 건의 Gen-AI 데이터 정책 위반, 중국...

#### The Hacker News
- **[[번역] Anthropic, 안전한 건강 기록 액세스 기능을 갖춘 의료용 Claude AI 출시](https://thehackernews.com/2026/01/anthropic-launches-claude-ai-for.html)**
  - Anthropic은 Claude 플랫폼 사용자가 다음 작업을 수행할 수 있도록 하는 새로운 기능 제품군을 발표한 최신 인공 지능(AI) 회사가 되었습니다....
...
- **[[번역] 연구원들이 산업 규모의 돼지 도살 사기를 조장하는 서비스 제공업체를 적발했습니다](https://thehackernews.com/2026/01/researchers-uncover-service-providers.html)**
  - 사이버 보안 연구원들은 온라인 범죄 네트워크에 필요한 도구와 인프라를 제공하는 두 서비스 제공업체에 대해 밝혀냈습니다....
...
- **[[번역] MuddyWater, 중동 전역에서 스피어 피싱을 통해 RustyWater RAT 출시](https://thehackernews.com/2026/01/muddywater-launches-rustywater-rat-via.html)**
  - MuddyWater로 알려진 이란의 위협 행위자는 외교, 해양, 금융, 통신 분야를 표적으로 삼은 스피어 피싱 캠페인에 기인한 것으로 나타났습니다....
...
- **[[번역] 유로폴, 590만 유로 규모 사기 및 조직범죄 혐의로 스페인 Black Axe 회원 34명 체포](https://thehackernews.com/2026/01/europol-arrests-34-black-axe-members-in.html)**
  - 유로폴은 지난 금요일 스페인에서 국제범죄조직 블랙 액스(Black Axe)의 일원으로 의심되는 34명을 체포했다고 발표했습니다....

- **[[번역] 중국 관련 해커, VMware ESXi 제로데이를 악용하여 가상 머신 탈출](https://thehackernews.com/2026/01/chinese-linked-hackers-exploit-vmware.html)**
  - `🚨제로데이` `🔥익스플로잇`
  - 중국어를 사용하는 위협 행위자는 손상된 SonicWall VPN 어플라이언스를 초기 액세스 벡터로 활용하여 VMware ES를 배포한 것으로 의심됩니다....
...
- **[[번역] 해커들이 하와이대학교 암센터 환자 데이터에 접근했습니다. 그들은 즉시 통보받지 못했습니다](https://www.securityweek.com/hackers-accessed-university-of-hawaii-cancer-center-patient-data-they-werent-immediately-notified/)**
  - UH 관계자는 어떤 암 연구 프로젝트가 영향을 받았는지, UH가 해커에게 돈을 되찾기 위해 얼마를 지불했는지 등 주요 정보 제공을 거부했습니다....
...
- **[[신년 인터뷰] 이주찬 굿모닝아이텍 대표 “2025년 보안 매출 ‘최대’...2026년 ‘산업별 제로트러스트 패키지화’ 추진”](https://www.dailysecu.com/news/articleView.html?idxno=204203)**
  - “보안 포트폴리오의 다각화를 통한 정보보호 전문 기업으로의 도약.” 굿모닝아이텍 이주찬 대표는 2025년을 이렇게 정리했다. 그는 급변하는 보안 위협 환경에서 고객 자산을 지키기 위한 ‘통합 보안 아키텍처’를 제시했고, 그 결과 보안 부문에서 역대 최대 매출 성과를 달성했다고 밝혔다. 반복되는 해킹 사고로 제로트러스트 보안에 대한 관심이 높아진 가운데, 마...
